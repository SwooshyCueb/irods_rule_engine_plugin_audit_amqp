...
> [!WARNING]
> If configuration loading fails during a reload, the values from the previous successfully loaded configuration will be used except where otherwise noted. If
